...
Menu obj=new Menu();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        FHorario fhorario = new FHorario();
        try {
            limpiarControles();
            horario = fhorario.ObtenerHorarioDadoCodigo(
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            try {
                ...
                if(fhorario.actualizar(horario) ){
...
DefaultTableModel modelo = (DefaultTableModel) TablaListarHorario.getModel();
        ...
        try {
            FHorario fhorario = new FHorario();
            lista = fhorario.ObtenerHorarios();
        } catch (Exception e) {
