...
public class FrmEmpresa extends javax.swing.JFrame {
  ...
  private void limpiarControles() {
    ...
    private void initComponents() {
        ...
        lblCodigofacultad.setText("Codigo ciudad:");
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(txtCodigociudad, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(70, 70, 70)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
Menu obj=new Menu();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            limpiarControles();
            empresa = fempresa.ObtenerEmpresaDadoCodigo(
                Integer.parseInt(txtCodigobuscar.getText()));
            if (empresa != null) {
                txtCodigo.setText(Integer.toString(empresa.getIdciudad()));
                txtCodigociudad.setText(Integer.toString(empresa.getIdciudad()));
        ...
        if (btnNuevo.getText().compareTo("Nuevo")==0) {
            ...
            if(btnNuevo.getText().compareTo("Registrar")==0){
                try {
                    ...
                    empresa.setIdciudad(Integer.parseInt(txtCodigociudad.getText()));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            try {
                ...
                if(fempresa.actualizar(empresa) ){
...
DefaultTableModel modelo = (DefaultTableModel) TablaListarempresa.getModel();
        ...
        try {
            FEmpresa fempresa = new FEmpresa();
            lista = fempresa.ObtenerEmpresas();
        } catch (Exception e) {
        ...
        for(Empresa p : lista){
            modelo.addRow(new Object[]{ p.getIdempresa(),p.getIdciudad(),p.getNombreempresa(),p.getDireccion1(),p.getDireccion2(),p.getEstado(),p.getSitioweb(),p.getEmail(),p.getTelefono()});
        }}
